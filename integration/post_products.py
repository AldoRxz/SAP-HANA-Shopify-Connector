    ...
    for _, row in merged_df.iterrows():
        product_data = {
            "product": {
                ...
                "tags": row['Tags'],
                "published": True,
                "images": [{"src": f"https://www.manijauto.com.mx/imagenes/{row['ItemCode']}.jpg"}],
                "variants": [{
                    "sku": row['ItemCode'],
                    "price": float(row['Price']),
                    "inventory_quantity": int(row['OnHand']),
                ...
                "metafields": [
                    {"namespace": "global", "key": "seo_title", "value": row['Title'], "type": "string"},
                    {"namespace": "global", "key": "seo_description", "value": row['SEO Description'], "type": "string"}
                ]
            }
        }
