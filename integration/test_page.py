...
try:
    ...
    merged_df = merged_df.head(100)  # Seleccionar solo los primeros 100 productos
    ...
    for _, row in merged_df.iterrows():
        ...
        try:
            ...
            if response.status_code == 201:
                uploaded_skus.append(row['Variant SKU'])
    ...
    # Mostrar lista de SKUs subidos
    print("\n✅ Lista de SKUs subidos:")
    for sku in uploaded_skus:
        print(sku)
